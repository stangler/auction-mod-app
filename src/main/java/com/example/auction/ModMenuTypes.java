...
import com.example.auction.auction.AuctionMenu;
import com.example.auction.market.FleaMarketMenu;
...
public class ModMenuTypes {
    ...
    public static final DeferredRegister<MenuType<?>> MENUS =
        DeferredRegister.create(Registries.MENU, AuctionMod.MOD_ID);
